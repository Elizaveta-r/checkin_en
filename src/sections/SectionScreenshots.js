...
import ModalPortal from "@/components/ModalPortal"; // adjust the path if needed
...
export default function SectionScreenshots() {
  ...
  return (
    <>
      {/* GALLERY */}
      <section className="grid grid-cols-3 sm:gap-8 gap-1 sm:p-0 px-3 max-w-275 items-center justify-center z-1">
